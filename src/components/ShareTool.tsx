...
const ShareTool = ({ onShare }: ShareToolProps) => (
  <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
    ...
    <p className="text-gray-600 text-sm sm:text-base md:text-lg mb-3 sm:mb-4">
      ...
      <button
        onClick={onShare}
        className="flex items-center gap-2 sm:gap-3 px-4 sm:px-6 md:px-8 py-3 sm:py-4 bg-green-500 text-white rounded-lg shadow hover:bg-green-600 hover:shadow-lg transition-colors font-semibold text-base sm:text-lg md:text-xl min-h-[44px] min-w-[44px]"
      >
