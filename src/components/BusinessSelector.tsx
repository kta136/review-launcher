    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4">
        {(Object.entries(businesses) as [BusinessKey, Business][]).map(([key, business]) => (
          <button
            ...
            className={`p-4 sm:p-6 md:p-8 rounded-lg border-2 transition-all duration-200 flex items-center gap-3 min-h-[44px] min-w-[44px] focus:outline-none focus:ring-2 focus:ring-amber-400 ${
